			...
			<div id="mutter">
				<div id="contents">
					...
					<form action="Top" method="post">
						...
						<input type="submit" name="button" value="つぶやく">
					</form>
				...
				<c:forEach var="mutter" items="${mutterList }">
					<div style="border: 1px solid #e9e9e9; border-radius: 5px; margin: 1em 0; padding: 2em;">
						...
						<c:if test="${mutter.delVisFlg==1}">
							<form action="Top" method="post">
								...
								<input type="hidden" name="likeCount" value="${mutter.likeCount }">
								<input type="hidden" name="commentCount" value="${mutter.commentCount }">
						...
						<form action="Top" method="post">
							...
							<input type="submit" name="button" value="コメント">
						</form>
